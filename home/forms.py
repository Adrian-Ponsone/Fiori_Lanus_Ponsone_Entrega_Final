...
class CarForm(forms.Form):
    ...
    fabrication_date = forms.DateField(required=False, label='Fabrication date (yyyy/mm/dd)')    
    car_description = RichTextFormField(required=False)
    posted_by = forms.CharField(required = False, max_length=20, label='type your username')
